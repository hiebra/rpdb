...
> All modules with a namespace starting by `com.softalks.` are debuggable by design. If your module or any importing module is using them you are free to ignore the fourth requirement
